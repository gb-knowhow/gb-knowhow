...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/css/notice/inquiry-detail.css" />
</head>
<body>
	<header id="header"><jsp:include
			page="${pageContext.request.contextPath}/templates/main/include/header.jsp" /></header>
	<div class="container-full">
			...
			<div class="question-content-inner">
				<div class="questionHead _questionContentsArea">
					...
					<div class="question_title">
						<img
							...
							style="margin-right: 3%; width: 50px; height: 50px;"> ${askAdmin.askAdminTitle}
						<!-- 버튼 클릭시 관리자에게 문의하는 페이지로 넘어가게 링크 걸어줌. 저렇게 쓰면 되는데 만약 데이터를 같이 움직여야 하면 컨트롤러 통해서 가자 -->
					</div>
					<!-- 질문 내용 -->
					<div class="question_content">
						${askAdmin.askAdminContent}
					</div>
				</div>
				<div></div>
				...
				<div class="question-userinfo">
					<span class="question-userinfo__info"> <!-- 작성자 닉네임 적기 --> <span
						style="padding-right: 10px;">${askAdmin.memberNickname}</span> <span class="blind">
							작성일 </span> ${askAdmin.askAdminRegDate}
					</span>
		...
		<!-- ANswerArea하기 -->
	 	<c:forEach var="answer" items="${askAdminAnswer}">
								...
								<div class="card_info">
									<div class="profile_info">
										...
										<div class="name_area" onclick="">
											<!-- 답글 단 사람 아이디 -->
											<strong class="name">${answer.memberNickname}</strong>
<!-- 											<div class="answerLikeArea">
 ...
 -->										</div>
							...
							<div class="answerWrite">
								<div class="answerOnlyContent">
										...
										<div class="answer-context">
											<div class="answer-textFull">
												<div class="answerOnlytext">
													<p class="answerTextPtag">${answer.askAdminAnswerContent}</p>
												</div>
											</div>
										</div>
									</div>
									<div class="answer-guideline">
										...
										<p class="answer-guideline-content">위 답변은 완벽한 해결책이 아닐수도 있습니다.</p>
									</div>
									<p class="answer-date">${answer.askAdminAnswerRegDate}</p>
	...
	<footer><jsp:include
			page="${pageContext.request.contextPath}/templates/main/include/footer.jsp" /></footer>
</body>
<script src="https://code.jquery.com/jquery-3.6.3.min.js"></script>
<script src="${pageContext.request.contextPath}/static/js/notice/detailsPage.js"></script>
</html>