...
<body>
<header id="header"><jsp:include page="${pageContext.request.contextPath}/templates/html/hhs/include/header.jsp" /></header>
...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/css/jyc/myUpdateInfo.css" />
</html>