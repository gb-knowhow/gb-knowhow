...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/css/admin/user-mentor-manager.css">
<link
			...
			<div class="right-body">
				...
				<div class="user-list-contents">
					<div class="member-input-wrap">
						...
						<div class="member-search-wrap">
							<div class="search-border">
								<form
									action="${pageContext.request.contextPath}/adminMentorListAction.admin"
									name="search-form">
									<img id="search-icon" alt="search"
										src="${pageContext.request.contextPath}/images/search-icon.png">

									<input class="member-search" type="text" name="mentorKeyword"
										value="${mentorKeyword}" "placeholder="멘토 이름 검색">
								</form>
							</div>
						</div>
					</div>
					...
					<div class="total-mentor">
						<p>총 멘토 수</p>
						<p class="total-mentor-num">${mentorTotal}</p>
					</div>
					...
					<div class="checkbox-group">
						...
						<c:forEach var="mentor" items="${mentors}">
							<c:if test="${mentor.resumeExistence}">
								<div class="mentor-list-contents">
									<input type="checkbox" id="check1" class="normal" value="">
									<div class="checkbox-zip"></div>
									<div class="user-num">${mentor.memberId}</div>
									<div class="user-role">멘토</div>
									<div class="user-name">${mentor.memberName}</div>
									<div class="user-email">${mentor.memberEmail}</div>
									<div class="user-reply">${mentor.questionCount}</div>
									<div class="user-comment">${mentor.totalCommentCount}</div>
						...
						<section id="content-wrap">
							...
							<div id="paging-wrap">
								<c:if test="${prev}">
									<a
										href="javascript:location.href='adminMentorListAction.admin?page=${startPage - 1}'"
								...
								<c:forEach var="i" begin="${startPage}" end="${endPage}">
									<c:choose>
										...
										<c:otherwise>
											<a
												href="javascript:location.href='adminMentorListAction.admin?page=${i}'"
								...
								<c:if test="${next}">
									<a
										href="javascript:location.href='adminMentorListAction.admin?page=${endPage + 1}'"
										class="paging paging-move"><img
...
<script>let mentors = `${mentors}`, contextPath = "${pageContext.request.contextPath}"</script>
</script>
</html>