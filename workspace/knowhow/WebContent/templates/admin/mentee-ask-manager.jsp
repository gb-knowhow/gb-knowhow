				...
				<div class="user-list-contents">
					<div class="member-input-wrap">
						<div class="member-delete-button-wrap">
							<input class="mentee-question-delete-button" type="submit"
								value="질문 삭제">
						</div>
						...
						<div class="member-search-wrap">
							<div class="search-border">
								<form
									action="${pageContext.request.contextPath}/adminQuestionListAction.admin"
									name="search-form">
									...
									<input class="member-search" type="text"
										name="menteeQuestionKeyword" value="${menteeQuestionKeyword}"
					...
					<div class="total-mentor">
						<p>전체 질문</p>
						<p class="total-mentor-num">${menteeQuestionTotal}</p>
					</div>
					...
					<div class="checkbox-group">
						<div class="mentor-list-header">
							...
							<div class="ask-title">제목</div>
							<div class="ask-contents">내용</div>
							<div class="answer-count">답변</div>
							<div class="ask-reply-count">댓글</div>
							<div class="user-ask-day">작성일시</div>
							<div class="detail"></div>
						</div>

						<!-- 여기부터 내용 -->
						<c:forEach var="question" items="${menteeQuestions}">
							<div class="mentor-list-contents">
								...
								<div class="ask-reply-count">${question.commentCount}</div>
								<div class="user-ask-day">${question.questionRegdate}</div>
								<div class="detail">
						...
						<section id="content-wrap">
							...
							<div id="paging-wrap">
								<c:if test="${prev}">
									<a
										href="javascript:location.href='adminQuestionListAction.admin?page=${startPage - 1}'"
								...
								<c:forEach var="i" begin="${startPage}" end="${endPage}">
									<c:choose>
										...
										<c:otherwise>
											<a
												href="javascript:location.href='adminQuestionListAction.admin?page=${i}'"
								...
								<c:if test="${next}">
									<a
										href="javascript:location.href='adminQuestionListAction.admin?page=${endPage + 1}'"
										class="paging paging-move"><img
