...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/css/board/questionModify.css" />
</head>
<body>
			...
			<form action="${pageContext.request.contextPath}/questionUpdateAction.question?questionId=${question.questionId}" style="display: block">
				<div>
					...
					<div style="line-height: 1.8">
						<span
							style="font-size: 12pt; font-family: 나눔바른고딕, NanumBarunGothic, NanumBarunGothicOTF;">
							페이지에 문제가 있거나 사이트의 질문이 있으시면 이 게시판이 아닌<br /> 문의 게시판에 글을 남겨주시면 최대한
							신속하게 확인하고 조치해드리겠습니다.
						</span>
					</div>
				</div>
				<fieldset class="InquiryInput_field_set_downContent">
					...
					<div class="InquiryInput_field_box InquiryInput_privacy">
						<dl>
							<dt class="InquiryInput_essential">
								<em class="blind">필수 입력 사항</em> <label for="moindividualInfoYn">개인정보
									수집 동의</label>
							</dt>
							<dd>
								...
								<div class="InquiryInput_check_box">
									<input type="checkbox" id="check_select1" class="input-agree"
										name="" /><label for="check_select1" class="lab">동의합니다.</label>
								</div>
							</dd>
						</dl>
					</div>
...
<script
	src="${pageContext.request.contextPath}/static/js/board/questionModify.js"></script>
</html>