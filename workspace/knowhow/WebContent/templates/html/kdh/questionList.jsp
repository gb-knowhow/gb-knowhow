              ...
              <div class="ranking_list_area" id="rankingChart">
                ...
                <ul class="ranking_list">
                  ...
                  <li class="ranking_item _item_5">
                    ...
                    <a href="/qna/detail.naver?d1id=8&amp;dirId=80507&amp;docId=28705162"
                      class="ranking_title" target="_blank" onclick="nhn.Kin.Utility.nClicks('hrk.list', '', '', event);">
                      이 새의종류가무엇인가요???
                    </a>
                    <a href="/qna/detail.naver?d1id=8&amp;dirId=80507&amp;docId=28705162"
                      class="text" target="_blank" onclick="nhn.Kin.Utility.nClicks('hrk.list', '', '', event);">
                      오늘 제 동생이놀이터에서놀다가 새끼새는 찾았는데 이새의 종류가무엇인지몰르겟어효 ㅜㅜ좀 가르쳐주세요...</a>
