...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/kdh/questionWrite.css"/>
  </head>
  <body>
              ...
              <div>
                <div style="line-height: 1.8">
                  <span
                    style="
                      font-size: 12pt;
                      font-family: 나눔바른고딕, NanumBarunGothic, NanumBarunGothicOTF;
                    "
                  >
              ...
              <fieldset class="InquiryInput_field_set_downContent">
                ...
                <div class="InquiryInput_field_box">
                  <dl>
                    ...
                    <dd>
                      <div class="InquiryInput_input_box">
                        <input id="mocustomerEmail" type="text" class="InquiryInput_input_text" />
                      </div>
                    </dd>
                  </dl>
                </div>
                <div class="InquiryInput_write_area">
                  <dl>
                    ...
                    <dd>
                      <textarea id="moText2CA" maxlength="1000"></textarea>
                  ...
                  <dl>
                    ...
                    <dd>
                      ...
                      <div class="InquiryInput_check_box">
                        <input type="checkbox" id="check_select1" name="" /><label
                          for="check_select1"
                          >동의합니다.</label
                        >
                      </div>
                ...
                <div class="CommonBtn_common_btn_wrap">
                  <div class="CommonBtn_common_btn_box">
                    <button type="button" class="CommonBtn_common_btn CommonBtn_on">
                      질문하기
                    </button>
                  </div>
                </div>
